...
function renderContentsSection() {
    ...
    html += '<div class="quick-section-title">Bab 1-21</div>';
    data.bab.forEach(bab => {
        html += `
        ...
        <div class="bab-card-home" onclick="showSection('can-do-list')" style="border-left-color: #059669;">
            ...
            <div class="bab-info-home">
                ...
                <div class="bab-title-home">
                    ...
                    <span class="translation-en">N3 Can Do List</span>
                    <span class="translation-id">Daftar Kemampuan N3</span>
                </div>
            </div>
        ...
        <section id="can-do-list" class="hidden">
            <div class="section-header">
                ...
                <div class="bab-header-title">
                    ...
                    <span class="bab-header-en">What You Can Do with N3 Grammar</span>
                    <span class="translation-id">Apa yang Dapat Anda Lakukan dengan Tata Bahasa N3</span>
                </div>
